...
def back():
    login()
def contact():
    os.system('xdg-open https://www.facebook.com/tui.amar.bal.2.0')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m TOOL VIRSION\033[1;91m :  \033[1;35m[\033[1;32m\033[1;92m7.3\033[1;35m]                       \033[1;91m|
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
  ...
  try:
    ...
    if id in httpCaht:
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801909170908?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
